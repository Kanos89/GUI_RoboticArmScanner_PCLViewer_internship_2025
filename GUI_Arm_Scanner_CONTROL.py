...
class StationController(QThread):
    ...
    def send_scanner_command(self, command):
        ...
        try:
            self.scanner_socket.settimeout(60)  # wait until 1 min for a response else shortcut the process
...
class MainWindow(QMainWindow):
    ...
    def init_ui(self):
        ...
        self.arm_host_input = QLineEdit("192.168.125.1")
        self.arm_port_input = QLineEdit("1234")
